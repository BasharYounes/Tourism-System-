...
class EventFlightReservationSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $completeflightIds = DB::table('event_flights')->pluck('id')->toArray();
        ...
        foreach (range(1, 50) as $index) { // عدد السجلات التي تريد توليدها
            ...
            DB::table('event_flight_reservations')->insert([
                'event_flight_id' => $faker->randomElement($completeflightIds), // معرف السيارة (افتراضًا لديك 100 سيارة)
